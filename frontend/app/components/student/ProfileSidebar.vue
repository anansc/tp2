<template>
    <section class="profile">
        <div class="profile__header">
            <img src="@/assets/perfil.png" alt="foto de perfil" class="profile__avatar" />

            <div class="profile__info">
                <h3 class="profile__name">Fulano da Silva Sauro</h3>
                <p class="profile__detail"><strong>Matrícula:</strong> 2320930</p>
                <p class="profile__detail"><strong>Status:</strong> ATIVO</p>
        ...
        <section class="profile__section">
            <h4 class="profile__sectionTitle">Médias</h4>
        ...
        <section class="profile__section">
            <h4 class="profile__sectionTitle">Integralizações</h4>
...
.profile__progressLabel {
    font-size: 12px;
    color: #333333;
}

.profile__progressValue {
    font-size: 12px;
    font-weight: 700;
    color: #1a5276;
}

.profile__progressTrack {
    height: 10px;
